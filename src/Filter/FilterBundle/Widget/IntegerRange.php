 ...
 */
class IntegerRange implements Widget
{
	/**
	 * @var
	 */
	...
	public function renderField($label, $name, $value, $data, $length)
    {
        return $this->twig->render(
            'FilterBundle:Widget:integerRange.html.twig',
            array(
                'label' => $label,
                'name' => $name,
                'value' => $value,
	...
	public function renderCaption($label, $name, $value, $data)
    {
        ...
        return $this->twig->render(
            'FilterBundle:Widget:integerRange_caption.html.twig',
            array(
                'label' => $label,
                'value' => $value,
            )
	...
	public function resolveCondition($qb, $alias, $value)
    {
        $placeholder = function($s) use ($alias) {
            return 'ir' . $s . '_' . str_replace('.', '_', $alias);
        };
